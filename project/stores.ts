...
const doc3 = new Document("doc3", "payload", uid40, [uid40, uid30, uid31], Consensus.ONLY_OWNER);
...
const p1 = new Transaction(TransactionType.ALLOW, doc3.id, uid990, pos0);
const p2 = new Transaction(TransactionType.DENY, doc3.id, uid990, pos1);
const p3 = new Transaction(TransactionType.DENY, doc3.id, uid990, pos2);

/* console.log(t1.id)
console.log(t2.id)
console.log(t3.id)
*/
const x1 = new Transaction(TransactionType.REQUEST, doc3.id, uid990);
// t2.id = x1.id;
